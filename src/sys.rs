...
/// Build a `libc::sockaddr_in` from a Rust `SocketAddrV4`. Shared by every call
/// site that needs to hand an IPv4 address to a libc socket call.
fn sockaddr_in_from(addr: std::net::SocketAddrV4) -> libc::sockaddr_in {
    libc::sockaddr_in {
...
/// Build a `libc::sockaddr_in6` from a Rust `SocketAddrV6`. Shared by every call
/// site that needs to hand an IPv6 address to a libc socket call.
fn sockaddr_in6_from(addr: std::net::SocketAddrV6) -> libc::sockaddr_in6 {
    libc::sockaddr_in6 {
